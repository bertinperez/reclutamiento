...
<html>
	<head>
		<title>Admonistrador - Practicantes Valdivieso Consultores</title>
		<meta charset="utf-8" />
		...
		<script type="text/javascript">
			...
			ajax2.open("POST", "templates/ajustes6.php", true);
													...
													<ul>
													    ...
													    <li>
													        ...
													        <option value="Seleccione una opción...">Seleccione una opción...</option>
																<?php  																	
																	$sqlllena = "SELECT idValor FROM valores"; 
													    ...
													    <li>
													    	<label for="beneficio">Valor :</label>											    	
													...
													<div class="register">
															<form class="register_form" action="" method="POST" name="update_form" enctype="multipart/form-data">
																<ul>
																    ...
																    <li>
																    	<label for="beneficio">Requisito :</label>											    	
																	...
																	<li>																										
																	    ...
																	    <button class="submit" type="reset" name="reset" id="reset">Limpiar Campos</button>				    												    															    
																	</li>					
																</ul>
															</form>		
														</div>
							...
							<?php  
								...
								if(!isset($_SESSION['usuario'])) {		
									...
									if(isset($_POST['delete'])) {
										$sqlDelete = "DELETE from valores where idValor=".$_POST['nombre'];	            	
										$queryDelete = mysqli_query($con,$sqlDelete);
										if ($queryDelete) {
											echo "<script>alert('El valor ha sido eliminado.');</script>";				            
										}
									} else if(isset($_POST['new'])) {
										echo "<script>location.href = '#openRegister'</script>";          
									} else if(isset($_POST['newb'])) {
										$sqlinsert = "INSERT INTO valores values(null,'".$_POST['newbeneficio']."');";
										$queryinsert = mysqli_query($con,$sqlinsert);
										if ($queryinsert) {
					                        /* Cuando el registro se guarda corractamente*/
					                        echo "<script>alert('Valor agregado con éxito.');</script>";				
