						...
						<div class="row 200%">
										...
										<article>																									<div class="register">
												<form class="register_form" action="" method="POST" name="register_form" enctype="multipart/form-data">
													<ul>
													    ...
													    <li>
													        <label for="entrada">¿Quienes somos? :</label>
													        <?php 
														        $sql0 ="select nosotros from empresa where idEmpresa = 1";        
							...
							<?php  
								...
								if(!isset($_SESSION['usuario'])) {		
									...
									$updateqs = "UPDATE empresa SET nosotros='".$_POST['entrada']."' where idEmpresa=1";	            	
									$queryqs = mysqli_query($con,$updateqs);
									if ($queryqs) {
