...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			ajax2.open("POST", "templates/ajustes.php", true);
													...
													<ul>
													    ...
													    <li>
													        ...
													        <option value="Seleccione una opción...">Seleccione una opción...</option>
																<?php  																	
																	$sqlllena = "SELECT idrequisito FROM requisitos"; 
							...
							<?php  
								...
								if(!isset($_SESSION['usuario'])) {		
									...
									if(isset($_POST['delete'])) {
										$sqlDelete = "DELETE from requisitos where idRequisito=".$_POST['nombre'];	            	
										...
										$sqlinsert = "INSERT INTO requisitos values(null,'".$_POST['newbeneficio']."');";
										$queryinsert = mysqli_query($con,$sqlinsert);
										if ($queryinsert) {
					                        /* Cuando el registro se guarda corractamente*/
					                        echo "<script>alert('Requisito agregado con éxito.');</script>";				
