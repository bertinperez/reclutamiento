...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			ajax2.open("POST", "templates/ajustes7.php", true);
											...
											<ul>
											    ...
											    <li>
											        ...
											        <option value="Seleccione una opción...">Seleccione una opción...</option>
														<?php  
															$texto = "Texto";
															$sqlllena = "SELECT idImagen FROM galeria"; 
												...
												<li>
													<button class="submit" type="submit" name="new" id="new" onclick="#openRegister">Agregar imagen</button>				    
													<button class="submit" type="submit" name="delete" id="delete">Eliminar imagen</button>				    												    
												</li>					
											</ul>
										</form>		
									</div>
														...
														<ul>
														    ...
														    <li>
														    	<label for="beneficio">Descripción :</label>											    	
														    	 ...
														    	 <span class="form_hint">Introduzca una descripción breve que le ayude a reconocer la imagen.</span>		
														    </li>
														    <li>
															...
															<li>																										
															    <button class="submit" type="submit" name="newb" id="newb">Publicar imagen</button>				    												    															    															    
															</li>					
														</ul>
													</form>		
												</div>
											...
											<div class="register">
													<form class="register_form" action="" method="POST" name="update_form" enctype="multipart/form-data">																										    
														<ul>
														    ...
														    <li>	
														    	<label for="imgvacante">Imagen :</label>											    															    	
														    	 <figure>
																	<img class="imgprofile" name="imgvacante" id="imgvacante" src="templates/obtenerImagenGaleria.php?id=<?php echo $idVacante; ?>" width="100%" heigth="300%">	
																</figure>
														    </li>														    
															<li>																																									    
															    <button class="submit" type="submit" name="deleteVacante" id="deleteVacante">Eliminar imagen</button>				    												    															    
															</li>					
														</ul>
													</form>		
												</div>
								...
								if(!isset($_SESSION['usuario'])) {		
					                ...
					                if (in_array($_FILES['picture']['type'], $permitidos) && $_FILES['picture']['size'] <= $limite_kb * 1024) { //Verifica que el tamaño se exceda
						            	...
						            	$data = mysqli_real_escape_string($con,$data);	            	        
											$sqlinsert = "INSERT INTO galeria values(null,'".$_POST['vacante']."','".$data."','".$tipo."');";
											$queryinsert = mysqli_query($con,$sqlinsert);
											if ($queryinsert) {
						                        /* Cuando el registro se guarda corractamente*/
						                        echo "<script>alert('Imagen agregada con éxito.');</script>";									                        
						                    }
				                    } else {
									...
									$sqlDelete = "DELETE from galeria where idImagen=".$_POST['elimvac'];	            	
									$queryDelete = mysqli_query($con,$sqlDelete);
									if ($queryDelete) {
										echo "<script>alert('La imagen ha sido eliminada con éxito.');</script>";		
